...
INTEGER, PARAMETER :: H_CUSTOM=-1,H_DEFAULT=0,H_LOGLAW=1,H_ABL=2,H_RAYLEIGH=3,H_YUAN=4, &   ! Heat transfer coefficient model
                      H_MORGAN=-5,H_VERTICAL_PLATE=-6,H_MORGAN_ONLY=-7
...
INTEGER, PARAMETER :: NULL_BOUNDARY=0,SOLID_BOUNDARY=1,OPEN_BOUNDARY=2,MIRROR_BOUNDARY=3, & ! Boundary Types
                      INTERPOLATED_BOUNDARY=6,PERIODIC_BOUNDARY=7
...
LOGICAL :: LES,DNS,RADIATION=.TRUE.,RADIATION_COMPLETED=.TRUE.,EXCHANGE_RADIATION=.FALSE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           PARTICLE_CFL=.FALSE.,IBM_FEM_COUPLING=.FALSE.,FDS5_OPTIONS=.FALSE.,&
           ...
           SOLID_HT3D=.FALSE.,SOLID_PYRO3D=.FALSE.,HVAC_MASS_TRANSPORT=.FALSE., &
