...
INTEGER, PARAMETER :: H_CUSTOM=-1,H_DEFAULT=0,H_LOGLAW=1,H_ABL=2,H_RAYLEIGH=3,H_YUAN=4,&
                      H_FREE_HORIZONTAL_CYLINDER=5,H_MORGAN=-6,H_VERTICAL_PLATE=-7, &
                      H_MORGAN_ONLY=-8                                                      ! Heat transfer coefficient model
...
REAL(EB) :: CPOPR,RSC,RPR,TMPA,TMPA4,RHOA,P_INF,RADIATIVE_FRACTION, &
            ...
            H_V_H2O(0:5000),CHI_R_MIN=0._EB,CHI_R_MAX=1._EB,DRAG_CFL_MAX,EVAP_FILM_FAC=1._EB/3._EB
...
REAL(EB) :: T_DEVC_LINE_END,T_RADF_BEGIN,T_RADF_END
...
CHARACTER(80)                              :: FN_STOP='null',FN_CPU,FN_CFL
...
CHARACTER(80), ALLOCATABLE, DIMENSION(:,:) :: FN_SLCF,FN_SLCF_GEOM,FN_BNDF,FN_BNDF_GEOM,FN_BNDG, &
                                              FN_ISOF,FN_SMOKE3D,FN_BNDF_SLCF,FN_RADF
