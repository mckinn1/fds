...
CALL READ_BRNR    ; IF (STOP_STATUS==SETUP_STOP) RETURN
...
NAMELIST /MISC/ AGGLOMERATION,AEROSOL_AL2O3,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,ASSUMED_GAS_TEMPERATURE,&
                ...
                CHECK_HT,CHECK_VN,CLIP_MASS_FRACTION,COMPUTE_CUTCELLS_ONLY,&
                ...
                WIND_ONLY,VEG_LEVEL_SET_SURFACE_HEATFLUX,VEG_LEVEL_SET_THERMAL_ELEMENTS, &
                VEG_LEVEL_SET_BURNERS_FOR_FIRELINE
...
NAMELIST /DUMP/ CLIP_RESTART_FILES,COLUMN_DUMP_LIMIT,CTRL_COLUMN_LIMIT,&
                ...
                SMOKE3D_SPEC_ID,STATUS_FILES,SUPPRESS_DIAGNOSTICS,T_DEVC_LINE_END,UVW_TIMER,VELOCITY_ERROR_FILE,WRITE_XYZ
...
! Add a species entry for unmixed fraction
...
NAMELIST /COMB/ CHECK_REALIZABILITY,COMPUTE_ZETA_SOURCE_TERM,EXTINCTION_MODEL,FIXED_MIX_TIME,FUEL_C_TO_CO_FRACTION,HRRPUV_MAX_SMV,&
                INITIAL_UNMIXED_FRACTION,MAX_CHEMISTRY_SUBSTEPS,N_FIXED_CHEMISTRY_SUBSTEPS,N_SIMPLE_CHEMISTRY_REACTIONS,&
                ODE_SOLVER,RADIATIVE_FRACTION,&
                RICHARDSON_ERROR_TOLERANCE,SUPPRESSION,TAU_CHEM,TAU_FLAME,TEMPERATURE_DEPENDENT_REACTION,&
                TRANSPORT_UNMIXED_FRACTION,TRANSPORT_ZETA_SCHEME,WD_PROPS
...
! Check the HRRPUV_MAX used by Smokeview to draw the flame
...
NAMELIST /REAC/ A,AUTO_IGNITION_TEMPERATURE,C,CHECK_ATOM_BALANCE,CO_YIELD,CRITICAL_FLAME_TEMPERATURE,&
                ...
                ID,IDEAL,N,NU,N_S,N_T,O,PRIORITY,RADIATIVE_FRACTION,RAMP_CHI_R,REAC_ATOM_ERROR,&
...
REAC_READ_LOOP: DO NR=1,N_REACTIONS
   ...
   IF (NR==2 .AND. N_SIMPLE_CHEMISTRY_REACTIONS==2) THEN
      ...
      PRIORITY = 2
      AUTO_IGNITION_TEMPERATURE = REACTION(1)%AUTO_IGNITION_TEMPERATURE - TMPM
   ELSE
      CALL CHECKREAD('REAC',LU_INPUT,IOS)
...
REAL(EB) :: VEG_DRAG_CONSTANT,VEG_ASH_FRACTION,VEG_CHAR_FRACTION,VEG_DENSITY,VEG_HEIGHT, &
            ...
            VEG_MOISTURE,VEG_SV,FIRELINE_MLR_MAX,VEG_GROUND_TEMP
...
REAL(EB) :: VEG_LSET_ROS_HEAD,VEG_LSET_ROS_FLANK,VEG_LSET_ROS_BACK, &
            VEG_LSET_WIND_EXP,VEG_LSET_BETA,VEG_LSET_FIREBASE_TIME,VEG_LSET_SURF_HEIGHT,VEG_LSET_SIGMA, &
            VEG_LSET_ROTH_ZEROWINDSLOPE_ROS,VEG_LSET_PHIDEPTH,VEG_LSET_HEAT_OF_COMBUSTION,VEG_LSET_SURF_LOAD, &
            VEG_LSET_CHAR_FRACTION,VEG_LSET_SURF_EFFM,VEG_LSET_CANOPY_BULK_DENSITY,VEG_LSET_CANOPY_HEIGHT, &
            VEG_LSET_FUEL_STRATA_GAP,VEG_LSET_CRUZ_PROB_PASSIVE,VEG_LSET_CRUZ_PROB_ACTIVE,VEG_LSET_CRUZ_PROB_CROWN, &
            VEG_LSET_WAF_UNSHELTERED,VEG_LSET_WAF_SHELTERED,VEG_LSET_CROWNFIRE_ANGLE,VEG_LSET_HRRPUA_MINIMUM_FRAC
LOGICAL :: DEFAULT,EVAC_DEFAULT,TGA_ANALYSIS,COMPUTE_EMISSIVITY,COMPUTE_EMISSIVITY_BACK,HT3D
LOGICAL :: VEG_LSET_HEADWIDTH_DEPENDENCE,VEGETATION,VEG_NO_BURN, &
           VEG_CHAR_OXIDATION,VEG_HCONV_CYLRE,VEG_HCONV_CYLLAM,VEG_HCONV_CYLMAX,VEG_LEVEL_SET_SPREAD,&
           VEG_LSET_BURNER,VEG_LSET_ELLIPSE,VEG_LSET_TAN2
...
NAMELIST /SURF/ ADIABATIC,AUTO_IGNITION_TEMPERATURE,&
                ...
                TMP_BACK,TMP_FRONT,TMP_INNER,TRANSPARENCY,VEGETATION,VEG_DRAG_CONSTANT,VEG_HCONV_CYLRE,VEG_HCONV_CYLLAM, &
                ...
                VEG_BETA_CHAR,VEG_NU_O2_CHAR,VEG_CHAR_ENTHALPY_FRACTION, &
                VEG_INITIAL_TEMP,VEGETATION_LAYERS,VEG_LOAD, &
                VEG_LSET_IGNITE_TIME,VEG_LSET_QCON,VEG_MOISTURE,VEG_NO_BURN,VEG_SV,VEG_LEVEL_SET_SPREAD,&
                VEG_LSET_BURNER,VEG_LSET_BURNER_TIME_OFF,VEG_LSET_BURNER_TIME_ON, &
                VEG_LSET_ROS_BACK,VEG_LSET_ROS_FLANK,VEG_LSET_ROS_HEAD,VEG_LSET_WIND_EXP, &
                VEG_LSET_SIGMA,VEG_LSET_FIREBASE_TIME,VEG_LSET_SURF_HEIGHT,VEG_LSET_BETA,VEG_LSET_ELLIPSE,VEG_LSET_TAN2, &
                VEG_LSET_ROTH_ZEROWINDSLOPE_ROS,VEG_DEGRADATION,VEG_LSET_SURFACE_FIRE_HEAD_ROS_MODEL, &
                VEG_LSET_CROWN_FIRE_HEAD_ROS_MODEL, &
                VEG_LSET_PHIDEPTH,VEG_LSET_HEAT_OF_COMBUSTION,VEG_LSET_SURF_LOAD,VEG_LSET_CHAR_FRACTION,VEG_LSET_SURF_EFFM,  &
                VEG_LSET_CANOPY_BULK_DENSITY,VEG_LSET_CANOPY_HEIGHT,VEG_LSET_FUEL_STRATA_GAP,VEG_LSET_CRUZ_PROB_PASSIVE, &
                VEG_LSET_CRUZ_PROB_ACTIVE,VEG_LSET_CRUZ_PROB_CROWN,VEG_LSET_WAF_UNSHELTERED,VEG_LSET_WAF_SHELTERED, &
                VEG_LSET_CROWNFIRE_ANGLE, &
                VEG_LSET_HRRPUA_MINIMUM_FRAC,VEG_LSET_HEADWIDTH_DEPENDENCE, &
...
READ_SURF_LOOP: DO N=0,N_SURF
   ...
   IF (VEG_LSET_FIREBASE_TIME == -1._EB) THEN !residence time of fire
     SF%VEG_LSET_FIREBASE_TIME  = 75600._EB/VEG_LSET_SIGMA !s, From Anderson
   ELSE
...
!                                             is used and burn time counter starts when phi >= -VEG_LSET_DEPTH
   ...
   SF%VEG_LSET_SURF_EFFM                   = VEG_LSET_SURF_EFFM*100._EB !%, fine fuel moisture surface veg
   ...
   SF%VEG_LSET_CROWN_VEG           = .FALSE.
   IF(VEG_LSET_CROWN_FIRE_HEAD_ROS_MODEL == 'CRUZ') SF%VEG_LSET_CROWN_VEG = .TRUE.
...
VEG_LSET_ROTH_ZEROWINDSLOPE_ROS = 1.0_EB !m/s Rothermel no-wind, no-slope ROS
...
!degrees. Maxiumum bound for implementing Cruz crown fire model, 180 means ROShead=CrownROS everywhere
VEG_LSET_CROWNFIRE_ANGLE     = 180._EB
...
PROCESS_SURF_LOOP: DO N=0,N_SURF
  ...
  ! Determine if the surface is combustible/burning
   ...
   IF (VEG_LEVEL_SET_COUPLED .AND. SF%HRRPUA > 0.0_EB) THEN !For Level Set mimicing of fixed heat source
...
USE SCRC, ONLY: SCARC_METHOD, SCARC_DISCRETIZATION, SCARC_VERBOSE, SCARC_DEBUG, SCARC_CSV, SCARC_ACCURACY, &
                ...
                SCARC_MULTIGRID, SCARC_MULTIGRID_ITERATIONS, SCARC_MULTIGRID_ACCURACY, SCARC_MULTIGRID_INTERPOL, &
                SCARC_MULTIGRID_CYCLE, SCARC_MULTIGRID_LEVEL, SCARC_MULTIGRID_COARSENING, SCARC_TWOLEVEL, &
                SCARC_SMOOTH, SCARC_SMOOTH_ITERATIONS, SCARC_SMOOTH_ACCURACY, SCARC_SMOOTH_OMEGA, &
                SCARC_PRECON, SCARC_PRECON_ITERATIONS, SCARC_PRECON_ACCURACY, SCARC_PRECON_OMEGA, &
