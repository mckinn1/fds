...
TYPE LAGRANGIAN_PARTICLE_TYPE
   ...
   LOGICAL :: LSET_THERMAL_ELEMENT=.FALSE.
...
INTEGER, PARAMETER :: N_WALL_SCALAR_REALS=12,N_WALL_SCALAR_INTEGERS=15,N_WALL_SCALAR_LOGICALS=0

TYPE WALL_TYPE
   TYPE (ONE_D_M_AND_E_XFER_TYPE) :: ONE_D
   LOGICAl :: LSET_FIRE=.FALSE.
   REAL(EB), POINTER, DIMENSION(:) :: A_LP_MPUA,AWM_AEROSOL,LP_CPUA,LP_MPUA
   REAL(EB), POINTER :: DUWDT,EW,Q_LEAK,UVW_GHOST,UW0,V_DEP,VEL_ERR_NEW,X,Y,Z
   REAL(EB), POINTER, DIMENSION(:) :: VEG_ASHMASS_L,VEG_CHARMASS_L,VEG_FUELMASS_L,VEG_MOISTMASS_L,VEG_TMP_L
   REAL(EB), POINTER :: VEG_HEIGHT,VEG_LSET_SURFACE_HEATFLUX
...
TYPE SURFACE_TYPE
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: VEG_KGAS_L,VEG_FUEL_FLUX_L,VEG_MOIST_FLUX_L,VEG_DIVQNET_L
   ...
   CHARACTER(25) :: VEG_LSET_SURFACE_FIRE_HEAD_ROS_MODEL,VEG_LSET_CROWN_FIRE_HEAD_ROS_MODEL
   LOGICAL  :: VEG_LSET_CROWN_VEG,VEG_LSET_HEADWIDTH_DEPENDENCE,VEG_LSET_BURNER,VEG_LSET_SPREAD,VEG_LSET_ELLIPSE,VEG_LSET_TAN2
   REAL(EB) :: VEG_LSET_BURNER_TIME_OFF,VEG_LSET_BURNER_TIME_ON,VEG_LSET_IGNITE_TIME,VEG_LSET_ROS_HEAD, &
               VEG_LSET_ROTH_ZEROWINDSLOPE_ROS, &
               VEG_LSET_QCON,VEG_LSET_ROS_FLANK,VEG_LSET_ROS_BACK, &
               VEG_LSET_WIND_EXP,VEG_LSET_PHIDEPTH,VEG_LSET_HEAT_OF_COMBUSTION,VEG_LSET_SURF_LOAD,VEG_LSET_CHAR_FRACTION, &
               VEG_LSET_SURF_EFFM,VEG_LSET_CANOPY_BULK_DENSITY,VEG_LSET_CANOPY_HEIGHT,VEG_LSET_FUEL_STRATA_GAP, &
               VEG_LSET_CRUZ_PROB_PASSIVE,VEG_LSET_CRUZ_PROB_ACTIVE,VEG_LSET_CRUZ_PROB_CROWN,VEG_LSET_WAF_UNSHELTERED, &
               VEG_LSET_WAF_SHELTERED,VEG_LSET_CROWNFIRE_ANGLE,VEG_LSET_HRRPUA_MINIMUM_FRAC

   !Veg SAV and height (fuel depth) for level set emulation of FARSITE
...
TYPE(BRNR_TYPE), DIMENSION(:), ALLOCATABLE :: BRNRINFO
...
TYPE OBSTRUCTION_TYPE
   ...
   ! 3D pyrolysis:
   LOGICAL :: PYRO3D=.FALSE.,MT3D=.FALSE.,HT3D=.FALSE.
...
TYPE GEOMETRY_TYPE
   CHARACTER(LABEL_LENGTH) :: ID='geom', MATL_ID='null'
...
TYPE CFACE_TYPE
   TYPE (ONE_D_M_AND_E_XFER_TYPE) :: ONE_D
   REAL(EB), POINTER :: AREA,X,Y,Z,NVEC(:),UW0,VEL_ERR_NEW
...
TYPE SLICE_TYPE
   INTEGER :: I1,I2,J1,J2,K1,K2,IOR=0,INDEX,INDEX2=0,Z_INDEX=-999,Y_INDEX=-999,MATL_INDEX=-999,&
              PART_INDEX=0,VELO_INDEX=0,PROP_INDEX=0,REAC_INDEX=0
